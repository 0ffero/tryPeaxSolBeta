...
var vars = {
    ...
    revisionInfo: [
        ...
        '                   - I could just give myself 3000 UPs and quickly test DELAYED, but Id rather put the testing time in to find any problems before this goes live.',
        ...
        'Revision 16    - Most recent high score is now highlighted (in green). After entering player name the page with the new score is automatically shown first.',
        '               - Changing "sort by" will also regenerate the pages and show players auto display the appropriate page',
        'Revision 17a   - UI Updates. Added shadows to well done screens text. Mostly implemented Replay buttons: Currently you have to change pages before the buttons show.',
        '         17b   - Replay buttons are now shown on entering the high score table.',
    ...
    game: {
        ...
        showUnlockedTint: ()=> { // hides the options containers, fades out UI and shows the applied tint. also fades everything back in after a time
            ...
            scene.tweens.add({
                ...
                yoyo: true,
                onComplete: ()=> {
                    //vars.containers.getByName('gamePlayingUIButtons').propertyValueSet('alpha',1);
    ...
    input: {
        ...
        dealWithClick: (_gameObject)=> { // deals with every clickable
            ...
            if (gameObject.name==='highScoreTableBG' && !vars.containers.ignoreLoop) { // the main screens are looping and the player clicked ont he high score bg
                let cV = vars.containers;
            ...
            // UNLOCK SCREEN BUTTONS (dealt with in unlockables)
        ...
        newGameOptionClicked: (_gameObject)=> {
            vars.audio.playSound('buttonClick');
